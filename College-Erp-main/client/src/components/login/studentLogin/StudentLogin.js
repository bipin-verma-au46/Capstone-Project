...
const StudentLogin = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-violet-500 to-fuchsia-500 h-screen w-screen flex items-center justify-center">
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          } w-96 bg-[radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(10,101,209,1) 58%, rgba(12,60,203,1) 78%)] flex flex-col items-center justify-center ${
            translate ? "-translate-x-[12rem]" : ""
